            ...
            @layer utilities {
                ...
                @media (prefers-color-scheme:dark) {
                    ...
                    .dark\:shadow-\[inset_0px_0px_0px_1px_\#fffaed2d\] {
                        ...
                        box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-shadow)
                    }
    ...
    <section class="flex flex-col w-full flex-grow px-10 pt-10">
        ...
        <section class="flex-1 flex flex-col lg:flex-row items-end lg:items-center pb-20">
            <div class="w-full lg:w-1/2">
                <h1
                    class="text-7xl md:text-8xl font-bold mb-8 leading-tight tracking-tight text-white drop-shadow-sm">
                    Soaring<br>beyond limits.
                </h1>
                <p
                    class="text-xl md:text-2xl mb-10 text-orange-100 max-w-lg font-light leading-relaxed">
                    The official website of Gordon College - College of Computer Studies Student Council.
                </p>
                <button
                    class="rounded-full px-10 py-4 bg-white text-[#B13407] font-bold text-lg hover:bg-orange-50 transition-all transform hover:scale-105 shadow-xl">
                    Visit Us
                </button>
            </div>
